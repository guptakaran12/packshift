...
<head>
    <meta charset="UTF-8">
    <title>{{ $isAdmin ? __('Password Reset Requested by User') : __('Reset Your Password | PackShift') }}</title>
</head>
...
<body
    ...
    <div
        ...
        <div style="background-color: #003366; padding: 20px; text-align: center;">
            <img src="{{ asset('images/logo2.png') }}" alt="{{ __('PackShift Logo') }}"
        ...
        <div style="padding: 30px;">
            @if ($isAdmin)
                ...
                <p style="font-size: 15px;">
                    {{ __('A user has requested a password reset. Below are the details:') }}
                </p>
                ...
                <p style="margin-top: 20px;">
                    <a href="{{ $resetPasswordUrl }}"
                        ...
                        {{ __('View in Admin Panel') }}
                    </a>
                </p>
            @else
                <h2 style="color: #2c3e50;">🔐 {{ __('Hello') }} {{ $user->first_name }},</h2>
                <p style="font-size: 16px;">
                    {{ __('We received a request to reset your password for your PackShift account.') }}
                </p>
